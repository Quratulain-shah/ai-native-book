...
- پیچیدہ کام کی وضاحتوں کے لئے ملٹی ٹرن گفتگو کی حمایت کریں
   - غلطی کی بازیابی اور وضاحت کے طریقہ کار کو شامل کریں

## خرابیوں کا سراغ لگانا

1. ** وژن کی شناخت کے مسائل **: روشنی کے حالات ، کیمرہ انشانکن ، اور آبجیکٹ کا پتہ لگانے کے پیرامیٹرز کی تصدیق کریں
2.
3.
4. ** انضمام کے مسائل **: پیغام کی قسم کی مطابقت اور نیٹ ورک کی تشکیل کی تصدیق کریں
5. ** کارکردگی کا انحطاط **: کمپیوٹیشنل وسائل کی نگرانی کریں اور ماڈل کی اصلاح کو بہتر بنائیں

## مشقیں

1. ** VLA ماڈل کی تربیت **: مصنوعی اعداد و شمار پر ایک سادہ VLA ماڈل کی تربیت کریں جس میں وژن اور زبان کے آدانوں کا امتزاج ہوتا ہے
2.
3. ** ایکشن میپنگ **: ایک میپنگ سسٹم بنائیں جو زبان کے احکامات کو روبوٹ کے اعمال میں تبدیل کرتا ہے
4.
5. ** مکمل VLA سسٹم **: تمام اجزاء کو ورکنگ وائس ٹو ایکشن سسٹم میں ضم کریں