    ...
    bookmark: () => {
      ...
      if (bookmarkContainer) {
        ...
        const addBookmarkBtn =
          bookmarkContainer.querySelector(".addCurrentBtn");
        if (addBookmarkBtn) {
          ...
          const bookmarkToggle =
            bookmarkContainer.querySelector(".bookmarkToggle");
          if (
            bookmarkToggle &&
            !bookmarkContainer.querySelector(
              '.bookmarksPanel[style*="display: block"], .bookmarksPanel:not([style*="display: none"])'
            )
          ) {
...
function createNotes() {
  ...
  function loadBookmarks() {
    ...
    if (bookmarks.length === 0) {
      bookmarksList.innerHTML =
        '<div class="empty-bookmarks">No bookmarks yet. Add some pages!</div>';
      return;
    }
    ...
    bookmarks.forEach((bookmark) => {
      ...
      bookmarkItem
        .querySelector(".bookmark-link-btn")
  ...
  notes
    .querySelector("#add-current-bookmark")
    .addEventListener("click", addCurrentBookmark);
