...
| Component | Model | Key Specs | Purpose |
|-----------|-------|-----------|---------|
| GPU | RTX 4090 | 24GB VRAM, CUDA 8.9 | Simulation, AI inference |
| Edge AI | Jetson Orin Nano | 8GB/16GB, 100TOPS | Physical deployment |
| Depth Camera | RealSense D435i | RGB + Depth, IMU | Perception |
| Robot | Unitree Go2/G1 | Quadruped, 2m/s | Physical AI validation |

This hardware setup enables the complete Physical AI development pipeline from simulation to real-world deployment, supporting the Theory → Digital Twin → Physical Deployment pedagogical approach.