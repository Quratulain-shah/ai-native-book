...
<ExerciseBox
  ...
  difficulty="medium"
  points={20}
  hints={["Consider the joint angles", "Think about the transformation matrices"]}
  solution="The forward kinematics can be calculated using the DH parameters."
>
  <p>Calculate the forward kinematics for a 3-DOF robotic arm with the given joint angles.</p>
</ExerciseBox>
...
<HardwareSpecs
  ...
  specs={[
    { name: "Processor", value: "ARM Cortex-A78", unit: "MHz", description: "High-performance processor for real-time control" },
    { name: "Memory", value: "8", unit: "GB", description: "LPDDR5 RAM for fast data processing" },
    { name: "Sensors", value: "IMU, LIDAR, Cameras", description: "Multiple sensors for environment perception" }
  ]}
  comparisonData={{
    models: [
